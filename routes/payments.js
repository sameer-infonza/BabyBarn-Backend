...
router.post('/checkout/membership', authenticate, ...requireCustomerFullAccount, (req, res, next) =>
...
router.get('/checkout/membership/summary', authenticate, ...requireCustomerFullAccount, (req, res, next) =>
