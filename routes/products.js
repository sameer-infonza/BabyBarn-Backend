...
router.get('/admin', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
  productController.getAllProductsAdmin(req, res).catch(next)
);
router.get('/admin/:id', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
  productController.getProductByIdAdmin(req, res).catch(next)
);

router.get('/categories/tree', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
  categoryController.getTree(req, res).catch(next)
);
...
router.put('/categories/:id', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
  categoryController.update(req, res).catch(next)
);
router.patch('/categories/:id/status', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
  categoryController.patchStatus(req, res).catch(next)
);
router.delete('/categories/:id', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) =>
...
router.post('/upload-image', authenticate, authorize('ADMIN', 'ADMIN_TEAM'), (req, res, next) => {
